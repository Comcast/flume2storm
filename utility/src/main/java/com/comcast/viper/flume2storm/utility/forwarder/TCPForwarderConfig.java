...
public class TCPForwarderConfig {
	public static final int MAX_WORKER_THREAD_DEFAULT = 10;
	...
	/**
	 * @return The port that the {@link TCPForwarder} uses to connect for
	...
	/**
	 * @return The maximum number of worker threads that the
	 *         {@link TCPForwarder} will create to process incoming connections
	 *         forwarding. This defaults to {@value #MAX_WORKER_THREAD_DEFAULT}.
	 */
	 ...
	 */
	@Override
	public int hashCode() { // NOPMD by gcommeau on 9/20/13 2:58 PM
		final int prime = 31;
		int result = 1;
	...
	public String toString() {
		return "TCPForwarderConfig [listenAddress=" + listenAddress + ", inputPort=" + inputPort + ", outputServer=" + outputServer + ", outputPort="
				+ outputPort + ", maxWorkerThread=" + maxWorkerThread + "]";
	}
}
