...
public class KryoNetTestUtil {
  ...
  public static void checkSenderStatus(final KryoNetEventSender sender, final KryoNetEventSenderStats expected) {
    Preconditions.checkNotNull(expected);
    Assert.assertTrue("Expected:" + expected + " but got: " + sender.getStats(), expected.sameAs(sender.getStats()));
  }

  public static void checkReceptorStatus(final KryoNetEventReceptor receptor, final KryoNetEventReceptorStats expected)
