...
public class ZkClientStateMachineTest extends ZkClientTestUtils {
  ...
  protected static final int FORWARDER_PORT = TestUtils.getAvailablePort();
  ...
  protected static class MyZkClientListener implements ZkClientListener {
    ...
    public void assertStatus(final int nbConnection, final int nbInitialization, final int nbTermination,
        final int nbDisconnection, final boolean checkNodeExists, final Boolean nodeExistsOnConnection)
        throws Exception {
