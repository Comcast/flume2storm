...
/**
 * Loads a Service Provider from a Configuration
 * 
 * @param <SP>
...
public interface ServiceProviderConfigurationLoader<SP extends ServiceProvider<?>> {
	/**
	 * @param config
	 *            The configuration to use to load a Service Provider. It
	 *            contains only the subset of configuration variables to load
	 *            one service provider
	 * @return The newly created Service Provider
	 */
	SP load(Configuration config);
}
